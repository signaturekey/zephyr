...
Do not review style, architectural aesthetics, general test-suite completeness, language or UI mechanisms already owned by `golang-expert`, `python-expert`, `typescript-expert`, `react-expert`, or `frontend-expert`, skill-authoring mechanics owned by `skill-authoring-expert`, or hypothetical behavior outside the packet.
