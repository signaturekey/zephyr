...
case "$kind" in
  ...
  reviewer)
    case "$role" in
      code-reviewer|architect-reviewer|golang-expert|python-expert|typescript-expert|react-expert|frontend-expert|skill-authoring-expert|reliability-expert|messaging-expert|infrastructure-expert|storage-expert|security-auditor|sql-expert|contract-reviewer|qa-expert|code-simplifier) ;;
      *)
