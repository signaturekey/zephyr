...
func roleScope(role string) string {
	scopes := map[string]string{
		...
		config.RoleReactExpert:          "React runtime, hooks, rendering, concurrency, state management, and ecosystem integrations",
		config.RoleFrontendExpert:       "framework-agnostic browser UI, accessibility, navigation, security, performance, and resilience",
